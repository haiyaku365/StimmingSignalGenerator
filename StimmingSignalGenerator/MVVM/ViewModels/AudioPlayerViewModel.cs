...
namespace StimmingSignalGenerator.MVVM.ViewModels
{
    ...
    public class AudioPlayerViewModel : ViewModelBase
    {
        ...
        public ReactiveCommand<Unit, Unit> SwitchToPortAudioAudioPlayerCommand { get; }
        ...
        public AudioPlayerViewModel(ISampleProvider sourceProvider)
        {
            ...
            FadeInDuration = ConfigurationHelper.GetConfigOrDefault(Constants.ConfigKey.FadeInDuration, 0.3d);
            ConfigurationHelper
               .AddUpdateAppSettingsOnDispose(Constants.ConfigKey.FadeInDuration, () => FadeInDuration.ToString())
               .DisposeWith(Disposables);
            FadeOutDuration = ConfigurationHelper.GetConfigOrDefault(Constants.ConfigKey.FadeOutDuration, 0.1d);
            ConfigurationHelper
            ...
            else
            {
                try
                {
                    SwitchAudioPlayer(AudioPlayerType.PortAudio);
                }
            ...
            SwitchToPortAudioAudioPlayerCommand = ReactiveCommand.Create(
               () => SwitchAudioPlayer(AudioPlayerType.PortAudio),
               canExecute: this.WhenAnyValue(
                  property1: x => x.CurrentAudioPlayerType,
                  property2: x => x.IsPlaying,
                  selector: (type, _) => type != AudioPlayerType.PortAudio && !IsPlaying)
               ).DisposeWith(Disposables);
        }
        ...
        public void SwitchAudioPlayer(AudioPlayerType audioPlayerType)
        {
            ...
            switch (audioPlayerType)
            {
                ...
                case AudioPlayerType.Wasapi:
                    ...
                    break;
                case AudioPlayerType.PortAudio:
                    if (AudioPlayer != null && AudioPlayer is PortAudioAudioPlayer) return;
                    break;
        ...
        public static AudioPlayerType GetAudioPlayerType(IAudioPlayer audioPlayer)
        {
            ...
            if (audioPlayer is PortAudioAudioPlayer) return AudioPlayerType.PortAudio;
        ...
        public IAudioPlayer CreateAudioPlayer(AudioPlayerType audioPlayerType)
        {
            return audioPlayerType switch
            {
                ...
                AudioPlayerType.PortAudio => new PortAudioAudioPlayer(sampleProvider.ToWaveProvider()).DisposeWith(Disposables),
